...
start wlrmdr -s 3600 -f 0 -t 禁用Windows Defender工具 -m 系统即将重启以禁用Windows Defender -a 10 -u rundll32.exe
...
start wlrmdr -s 3600 -f 0 -t 启用Windows Defender工具 -m 系统即将重启以启用Windows Defender -a 10 -u rundll32.exe
del /f /q "%temp%\NSudo.exe" >nul
del /f /q "%temp%\DisableMain.bat" >nul
del /f /q "%temp%\EnableMain.bat" >nul
del /f /q "%temp%\Disable8.bat" >nul
